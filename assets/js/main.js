...
var accordion = document.querySelector('.acc-btn');

accordion.addEventListener('click', () =>{
//   var target = event.target;

  var accbody= document.querySelector('.panel');
...
//   logo slider
var forwardSwiper = new Swiper('.forward-slider', {
    slidesPerView: 1,
    loop: true,
    autoplay: {
  ...
  // Initialize Swiper for backward slider
  var backwardSwiper = new Swiper('.backward-slider', {
    slidesPerView: 1,
    loop: true,
    direction: 'rtl', // Reverse direction for a "backward" effect
    autoplay: {
      delay: 3000, // milliseconds between slides
    }
  });
  ...
  $(document).ready(function() {
    ...
    $("#brochure-form").submit(function(e) {
        ...
        setTimeout(function () {
            ...
            // Display a result message or update the page content here
            $("#result").html("Form submitted successfully!");
        }, 3000); // Simulating a 3-second form submission time
    });
});